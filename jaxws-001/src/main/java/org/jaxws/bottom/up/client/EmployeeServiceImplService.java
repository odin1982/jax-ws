 ...
 * 
 */
@WebServiceClient(name = "EmployeeServiceImplService", targetNamespace = "http://up.bottom.jaxws.org/", wsdlLocation = "http://localhost:8080/employeeservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EMPLOYEESERVICEIMPLSERVICE_QNAME = new QName("http://up.bottom.jaxws.org/", "EmployeeServiceImplService");
    ...
    public EmployeeService getEmployeeServiceImplPort() {
        return super.getPort(new QName("http://up.bottom.jaxws.org/", "EmployeeServiceImplPort"), EmployeeService.class);
    }
    ...
    public EmployeeService getEmployeeServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://up.bottom.jaxws.org/", "EmployeeServiceImplPort"), EmployeeService.class, features);
    }
