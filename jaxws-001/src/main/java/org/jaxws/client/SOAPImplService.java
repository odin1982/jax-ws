 ...
 * 
 */
@WebServiceClient(name = "SOAPImplService", targetNamespace = "http://soap.jaxws.org/", wsdlLocation = "http://localhost:1516/WS/Users?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SOAPIMPLSERVICE_QNAME = new QName("http://soap.jaxws.org/", "SOAPImplService");
    ...
    public SOAPI getSOAPImplPort() {
        return super.getPort(new QName("http://soap.jaxws.org/", "SOAPImplPort"), SOAPI.class);
    }
    ...
    public SOAPI getSOAPImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.jaxws.org/", "SOAPImplPort"), SOAPI.class, features);
    }
