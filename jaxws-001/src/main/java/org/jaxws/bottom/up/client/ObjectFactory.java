 ...
 * generated in the org.jaxws.bottom.up.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _AddEmployee_QNAME = new QName("http://up.bottom.jaxws.org/", "addEmployee");
    private final static QName _GetEmployeeResponse_QNAME = new QName("http://up.bottom.jaxws.org/", "getEmployeeResponse");
    private final static QName _DeleteEmployee_QNAME = new QName("http://up.bottom.jaxws.org/", "deleteEmployee");
    private final static QName _UpdateEmployeeResponse_QNAME = new QName("http://up.bottom.jaxws.org/", "updateEmployeeResponse");
    private final static QName _AddEmployeeResponse_QNAME = new QName("http://up.bottom.jaxws.org/", "addEmployeeResponse");
    private final static QName _GetEmployee_QNAME = new QName("http://up.bottom.jaxws.org/", "getEmployee");
    private final static QName _UpdateEmployee_QNAME = new QName("http://up.bottom.jaxws.org/", "updateEmployee");
    private final static QName _DeleteEmployeeResponse_QNAME = new QName("http://up.bottom.jaxws.org/", "deleteEmployeeResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.jaxws.bottom.up.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://up.bottom.jaxws.org/", name = "addEmployee")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://up.bottom.jaxws.org/", name = "getEmployeeResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://up.bottom.jaxws.org/", name = "deleteEmployee")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://up.bottom.jaxws.org/", name = "updateEmployeeResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://up.bottom.jaxws.org/", name = "addEmployeeResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://up.bottom.jaxws.org/", name = "getEmployee")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://up.bottom.jaxws.org/", name = "updateEmployee")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://up.bottom.jaxws.org/", name = "deleteEmployeeResponse")
