 ...
 * 
 */
@WebServiceClient(name = "PersonServiceImplService", targetNamespace = "http://service.jaxws.org/", wsdlLocation = "http://localhost:8081/ws/person?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICEIMPLSERVICE_QNAME = new QName("http://service.jaxws.org/", "PersonServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8081/ws/person?wsdl");
    ...
    public PersonService getPersonServiceImplPort() {
        return super.getPort(new QName("http://service.jaxws.org/", "PersonServiceImplPort"), PersonService.class);
    }
    ...
    public PersonService getPersonServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.jaxws.org/", "PersonServiceImplPort"), PersonService.class, features);
    }
